// To Long: Remember to revert changes in theme.dart later. 
                    ...
                    child: Column(
                      ...
                      children: [
                        RichText(
                          text: const TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'longhung' + ' ', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),
                              TextSpan(text: 'đã trở thành người theo dõi của bạn.', style: TextStyle(color: Colors.black)),
                            ]
                          )
                        ),
                        const Text(
                      ...
                      children: [
                        RichText(
                          text: const TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'longhung' + ' ', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),
                              TextSpan(text: 'đã thích bài viết của bạn.', style: TextStyle(color: Colors.black)),
                            ]
                          )
                        ),
                        const Text(
                    ...
                    child: Column(
                      ...
                      children: [
                        RichText(
                          text: const TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'lannguyen' + ' ', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),
                              TextSpan(text: 'đã thích bài viết của bạn.', style: TextStyle(color: Colors.black)),
                            ]
                          )
                        ),
                    ...
                    child: Column(
                      ...
                      children: [
                        RichText(
                          text: const TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'khaido' + ' ', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),
                              TextSpan(text: 'đã trở thành người theo dõi của bạn.', style: TextStyle(color: Colors.black)),
                            ]
                          )
                        ),
                    ...
                    child: Column(
                      ...
                      children: [
                        RichText(
                          text: const TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'hoangngoc' + ' ', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),
                              TextSpan(text: 'đã thích bài viết của bạn.', style: TextStyle(color: Colors.black)),
                            ]
                          )
                        ),
                    ...
                    child: Column(
                      ...
                      children: [
                        RichText(
                          text: const TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'hungnguyen' + ' ', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),
                              TextSpan(text: 'đã trở thành người theo dõi của bạn.', style: TextStyle(color: Colors.black)),
                            ]
                          )
                        ),
    ...
    if (isScreenExists) {
      switch (index) {
        ...
        case NOTIFICATIONS_SCREEN_INDEX:
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => const InboxScreen()));
          break;
      }
    }
  }
